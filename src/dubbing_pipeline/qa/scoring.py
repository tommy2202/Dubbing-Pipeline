...
from dubbing_pipeline.review.ops import resolve_job_dir
...
def score_job(
    ...
    *,
    ...
    try:
        from dubbing_pipeline.projects.loader import load_job_qa_profile
        ...
        "top_issues": [
            {
                ...
                **iss.to_dict(),
                "fix": {
                    ...
                    "cli": [
                        f"dubbing-pipeline review show {job_dir.name} {int(sid)}",
                        f'dubbing-pipeline review edit {job_dir.name} {int(sid)} --text "..."',
                        f"dubbing-pipeline review regen {job_dir.name} {int(sid)}",
                        f"dubbing-pipeline review lock {job_dir.name} {int(sid)}",
                    ],
                },
            }
