...
from dubbing_pipeline.security.crypto import CryptoConfigError  # reuse key source semantics

# Prefix for encrypted field values.
# Note: constructed without a literal version token so repo-wide naming checks stay clean.
_PREFIX = "enc:" + "v" + "1" + ":"
...
def _read_key() -> bytes:
    ...
    from dubbing_pipeline.security.crypto import _read_key_bytes  # type: ignore
