...
from dubbing_pipeline.stages.tts_engine import CoquiXTTS, choose_similar_voice, load_voice_db
    ...
    for i, cand in enumerate(candidates, 1):
        ...
        try:
            if engine is not None:
                ...
                from dubbing_pipeline.stages.tts import _espeak_fallback  # type: ignore
