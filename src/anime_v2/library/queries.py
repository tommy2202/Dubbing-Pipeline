...
from anime_v2.api.deps import Identity
    ...
    *,
    ...
    try:
        ...
        for r in rows:
            ...
            if job is not None:
                try:
                    from anime_v2.library.manifest import read_manifest as _rm
                    from anime_v2.library.paths import get_library_root_for_job, get_job_output_root
